    ...
    <div class="ig-edit-wrap">
        <div class="ig-edit-card">
                ...
                <form id="editProfileForm" action="{{ route('profile.update') }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="ig-avatar-section mb-4">
                        ...
                        <div class="avatar-upload-info">
                            ...
                            <input type="file" name="avatar" id="avatar" class="ig-file"
                    ...
                    <div class="ig-block">
                        ...
                        <input type="text" name="name" id="name" class="ig-input"
                    ...
                    <div class="ig-block">
                        ...
                        <input type="text" name="email" id="email" class="ig-input"
            ...
            <div class="ig-edit-foot">
                <button type="submit" form="editProfileForm" class="ig-post-btn w-100">Save Changes</button>
            </div>
