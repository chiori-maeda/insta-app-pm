            ...
            <div class="modal-content modal-content-admin activate-modal">
                <div class="modal-header-admin">
                    ...
                    <div class="modal-header-text">
                        <h3 class="modal-title-admin">Unhide Post</h3>
                        <p class="modal-subtitle-admin">Post ID: #{{ $post->id }}</p>
                    </div>
                ...
                <div class="modal-body-admin">
                    <div class="confirmation-message">
                        ...
                        <div class="post-preview-card mt-3">
                            <img src="{{ $post->image }}" alt="Post {{ $post->id }}" class="modal-post-img">
                ...
                <div class="modal-footer-admin">
                    <form action="{{ route('admin.posts.activate', $post->id) }}" method="post" class="w-100">
                        @csrf
                        @method('PATCH')
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content modal-content-admin deactivate-modal">
                <div class="modal-header-admin">
                    ...
                    <div class="modal-header-text">
                        <h3 class="modal-title-admin">Hide Post</h3>
                        <p class="modal-subtitle-admin">Post ID: #{{ $post->id }}</p>
                    </div>
                    <button type="button" class="btn-close-modal" data-bs-dismiss="modal">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                ...
                <div class="modal-body-admin">
                    <div class="confirmation-message">
                        ...
                        <div class="post-preview-card mt-3">
                            <img src="{{ $post->image }}" alt="Post {{ $post->id }}" class="modal-post-img">
                            <p class="consequence-text danger-text mt-2">This post will no longer be visible to users.</p>
                        </div>
                    </div>
                </div>
                
                <div class="modal-footer-admin">
                    <form action="{{ route('admin.posts.deactivate', $post->id) }}" method="post" class="w-100">
                        @csrf
                        @method('DELETE')
